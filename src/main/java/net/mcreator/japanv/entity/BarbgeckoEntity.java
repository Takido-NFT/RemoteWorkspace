...
package net.mcreator.japanv.entity;
...
public class BarbgeckoEntity extends Monster implements IAnimatable {
	...
	public BarbgeckoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JapanvModEntities.BARBGECKO.get(), world);
	}

	public BarbgeckoEntity(EntityType<BarbgeckoEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(JapanvModEntities.BARBGECKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BarbgeckoEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
